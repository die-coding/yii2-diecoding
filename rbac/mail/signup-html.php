...
# @Last modified time: 10 December 2017
# @License: MIT
# @Copyright: 2017
...
$link = Yii::$app->urlManager->createAbsoluteUrl(['site/aktivasi', 'user' => $user->username, 'token' => $user->auth_key]);
?>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td style="color:#757575;font-family:'Roboto',OpenSans,'Open Sans',Arial,sans-serif;font-size:17px;font-weight:300;line-height:24px;margin:0;padding:0 25px 0 25px;text-align:center" align="center">
                            Terima kasih telah melakukan registrasi. Silakan klik tombol di bawah ini untuk mengaktifkan akun anda :
                          </td>
                        </tr>
                        <tr>
                          <td height="20"></td>
                        ...
                        <tr>
                          <td style="padding-left:8px;padding-right:8px;text-align:center">
                            <?= Html::a('AKTIFKAN AKUN', $link, ['style' => 'font-family:Roboto-Regular,Helvetica,Arial,sans-serif;color:#ffffff;background-color:#4285f4;font-weight:400;line-height:20px;text-decoration:none;font-size:14px;padding: 10px 15px;', 'target' => '_blank']) ?>
                          </td>
                        </tr>
