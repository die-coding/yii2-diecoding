...
class Menu extends \yii\widgets\Menu
{
  ...
  */
  public static $iconClassPrefix = "icon-";
  ...
  */
  protected function renderItem($item)
  {
    if(isset($item["linkOptions"])) {
      $linkOption = ArrayHelper::getValue($item, "linkOptions", []);
      $labelTemplate = Html::a("{icon} {label}", "{url}", $linkOption);
      $linkTemplate = Html::a("{icon} {label}", "{url}", $linkOption);
    } else {
