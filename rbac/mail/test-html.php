                      ...
                      <tbody>
                        ...
                        <tr>
                          <td style="padding-left:8px;padding-right:8px;text-align:center">
                            <?= Html::a('AKTIFKAN AKUN', ['TEST'], ['style' => 'font-family:Roboto-Regular,Helvetica,Arial,sans-serif;color:#ffffff;background-color:#4285f4;font-weight:400;line-height:20px;text-decoration:none;font-size:14px;padding: 10px 15px;', 'target' => '_blank']) ?>
                          </td>
                        </tr>
